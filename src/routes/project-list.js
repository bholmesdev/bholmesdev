module.exports = [
  ...
  {
    title: 'Drawchange Volunteer Management System',
    hash: 'drawchange',
    links: [
      {
        href: 'https://bitsofgood.org/projects/vms',
        text: `Check out how the project has evolved`,
      },
      {
        href:
          'https://dev.to/bholmesdev/let-css-frameworks-empower-you-not-control-you-3hm0',
        text: `Read our big takeaway on CSS frameworks`,
        icon: 'devto',
      },
      {
        href:
          'https://twitter.com/search?q=%40bholmesdev%20%22bits%20of%20good%22%20%22admin%22&src=typed_query',
        text: 'Check out progress updates along the way',
        icon: 'twitter',
      },
    ],
    timeframe: 'Jan - May 2019',
    category: 'completed',
    tags: ['MERN stack', 'Social good', 'ReactJS'],
    img: {
      src: '/static/projects/drawchange.jpg',
      alt: 'Drawchange admin portal, with view of volunteer profiles',
    },
    videoSrc: '/static/projects/drawchange.webm',
    backupVideoSrc: '/static/projects/drawchange.mp4',
    body: `This was a major milestone as a developer: my first time taking ownership of a production-ready project. Since this Bits of Good student team was short-staffed, I ended up being the <strong>team-lead-SCRUM-master-client-communicator-designer-developer</strong> (my longest title so far!). It was also an amazing chance to make full stack architecture choices my team could agree on, and an opportunity to pair up and teach others as we worked towards the deadline. Though <a href="https://www.drawchange.org">our nonprofit partner</a> parted ways with BoG, the codebase has been reimagined as a <a href="https://bitsofgood.org/projects/vms">general solution for volunteer management</a> that all nonprofits can use!`,
  },
  {
